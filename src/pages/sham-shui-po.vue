...
import BgSvg from "../assets/sham-shui-po_bg.svg?component";
import DistrictIcon from "../assets/sham-shui-po_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#782C57");
    const coverColor = ref("rgb(66,26,46)");
