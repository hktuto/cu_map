...
import BgSvg from "../assets/saikung_bg-01.svg?component";
import DistrictIcon from "../assets/saikung_icon-01.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#6C6780");
    const coverColor = ref("rgb(52,48,84)");
