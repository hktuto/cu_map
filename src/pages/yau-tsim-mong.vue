...
import BgSvg from "../assets/yau-tsim-mong_bg.svg?component";
import DistrictIcon from "../assets/yau-tsim-mong_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#A91E39");
    const coverColor = ref("rgb(104,32,20)");
