...
import BgSvg from "../assets/kwun-tong_bg.svg?component";
import DistrictIcon from "../assets/kwun-tong_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#764880");
    const coverColor = ref("rgb(63,32,70)");
