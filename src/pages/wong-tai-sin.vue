...
import BgSvg from "../assets/wong-tai-sin_bg.svg?component";
import DistrictIcon from "../assets/wong-tai-sin_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#225945");
    const coverColor = ref("rgb(29,59,27)");
