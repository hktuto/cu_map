...
import BgSvg from "../assets/wanchai_bg.svg?component";
import DistrictIcon from "../assets/wanchai_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#726799");
    const coverColor = ref("rgb(54,48,101)");
