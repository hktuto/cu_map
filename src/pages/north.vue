...
import BgSvg from "../assets/north_bg.svg?component";
import DistrictIcon from "../assets/nt_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#636648");
    const coverColor = ref("rgb(50,51,33)");
