...
import BgSvg from "../assets/tuen-mun_bg.svg?component";
import DistrictIcon from "../assets/tuen-mun_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#B3584F");
    const coverColor = ref("rgb(111,55,46)");
