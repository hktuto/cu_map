...
import BgSvg from "../assets/kowloonCity_bg.svg?component";
import DistrictIcon from "../assets/kowloonCity_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#806024");
    const coverColor = ref("rgb(73,56,27)");
