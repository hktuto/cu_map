...
import BgSvg from "../assets/central_bg.svg?component";
import DistrictIcon from "../assets/central_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#238080");
    const coverColor = ref("rgb(25,66,62)");
