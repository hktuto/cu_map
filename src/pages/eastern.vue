...
import BgSvg from "../assets/eastern_bg.svg?component";
import DistrictIcon from "../assets/eastern_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#487482");
    const coverColor = ref("rgb(26,67,90)");
