...
import BgSvg from "../assets/sha-tin_bg.svg?component";
import DistrictIcon from "../assets/sha-tin_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#496D80");
    const coverColor = ref("rgb(29,73,99)");
