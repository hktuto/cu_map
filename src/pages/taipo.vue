...
import BgSvg from "../assets/taipo_bg-01.svg?component";
import DistrictIcon from "../assets/taipo_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#318080");
    const coverColor = ref("rgb(25,66,33)");
