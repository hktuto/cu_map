...
import BgSvg from "../assets/kwai-tsing_bg-01.svg?component";
import DistrictIcon from "../assets/kwai-tsing_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#565859");
    const coverColor = ref("rgb(60,62,64)");
