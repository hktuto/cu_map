...
import BgSvg from "../assets/tsuen-wan_bg.svg?component";
import DistrictIcon from "../assets/tsuen-wan_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#6E9CAA");
    const coverColor = ref("rgb(18,51,99)");
