...
import BgSvg from "../assets/southern_bg.svg?component";
import DistrictIcon from "../assets/southern_icon.svg?component";
...
export default defineComponent({
  ...
  setup() {
    const bgColor = ref("#5B879E");
    const coverColor = ref("rgb(38,90,121)");
